...
public interface IModularCommonControlListModel
{
...
public class ModularCommonControlListModel : IModularCommonControlListModel
{
    ...
    public ModularCommonControlListModel(IModularGroupDataItemRepository repo)
    {
        _repo = repo;
        Initialize();
    }
