...
using TInterface = Jlw.ModularContent.IModularContentFieldRepository;

namespace Jlw.Data.ModularContent.Tests
{

    [TestClass]
    public class AddModularContentFieldRepositoryTestFixture
    {
        ...
        /// <summary>
        /// Asserts that an instance of the <c>ModularContentFieldRepository</c> is added to the service collection when the <c>AddModularContentFieldRepository</c> method is called with lambda options
        /// </summary>
        ...
        ///     <item>Asserts that the repository is an instance of <see cref="ModularContentFieldRepository" />.</item>
        ///   </list>
        /// </remarks>
        /// <autogeneratedoc />
        [TestMethod]
        ...
        /// <summary>
        /// Asserts that the instance of the <c>ModularContentFieldRepository</c> was created with the correct instance of <c>IModularDbClient</c> when the method is called
        /// without arguments, and falls back to retrieving an instance of <c>ModularContentFieldRepositoryOptions</c> from the service collection.
        /// </summary>
        /// <param name="dbClient">The database client.</param>
        /// <param name="connString">The connection string.</param>
        /// <remarks>
        ...
        {
            IServiceCollection services = new ServiceCollection();
            services.AddSingleton(new ModularContentFieldRepositoryOptions() { DbClient = _dbClient, ConnectionString = connString });
            services.AddModularContentFieldRepository();
        ...
        /// <summary>
        /// Asserts that the instance of the <c>AddModularContentFieldRepository</c> was created with the correct instance of <c>IModularDbClient</c> when the method is called
        /// without arguments, and falls back to the retrieving an instance of <c>IOptions&lt;ModularContentFieldRepositoryOptions&gt;</c> from the service collection.
        /// </summary>
        /// <param name="dbClient">The database client.</param>
        /// <param name="connString">The connection string.</param>
        /// <remarks>
        ...
        {
            IServiceCollection services = new ServiceCollection();
            services.AddSingleton<IOptions<ModularContentFieldRepositoryOptions>>(new OptionsWrapper<ModularContentFieldRepositoryOptions>(new ModularContentFieldRepositoryOptions(){ DbClient = _dbClient, ConnectionString = connString}));
            services.AddModularContentFieldRepository();
        ...
        /// <summary>
        /// Asserts that the instance of the <c>AddModularContentFieldRepository</c> was created with the correct instance of <c>IModularDbClient</c> when the method is called with lambda options
        /// </summary>
        /// <param name="dbClient">The database client.</param>
        /// <param name="connString">The connection string.</param>
        /// <remarks>
        ...
        /// <summary>Asserts that the service collection returns a singleton for <c>IModularContentFieldRepository</c></summary>
        /// <autogeneratedoc />
        [TestMethod]
        ...
        {
            IServiceCollection services = new ServiceCollection();
            var svc = services.AddModularContentFieldRepository(options =>
            {
                options.DbClient = _dbClient;
                options.ConnectionString = _connString;
            });
