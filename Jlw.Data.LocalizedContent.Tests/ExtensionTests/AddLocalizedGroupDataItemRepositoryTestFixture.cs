...
{
    [TestClass]
    public class AddLocalizedGroupDataItemRepositoryTestFixture
    {
        ...
        /// <summary>
        /// Asserts that an instance of the <c>LocalizedGroupDataItemRepository</c> is added to the service collection when the <c>AddLocalizedGroupDataItemRepository</c> method is called with lambda options
        /// </summary>
        ...
        ///     <item>Asserts that the repository is an instance of <see cref="ModularGroupDataItemRepository" />.</item>
        ///   </list>
        /// </remarks>
        /// <autogeneratedoc />
        [TestMethod]
        ...
        public void Instance_Should_Be_Added_To_ServiceCollection(IModularDbClient dbClient, string connString)
        {
            ...
            Assert.IsInstanceOfType(repo, typeof(IModularGroupDataItemRepository));

        }

        /// <summary>
        /// Asserts that the instance of the <c>LocalizedGroupDataItemRepository</c> was created with the correct instance of <c>IModularDbClient</c> when the method is called
        /// without arguments, and falls back to retrieving an instance of <c>LocalizedGroupDataItemRepositoryOptions</c> from the service collection.
        /// </summary>
        /// <param name="dbClient">The database client.</param>
        /// <param name="connString">The connection string.</param>
        /// <remarks>
        ...
        {
            IServiceCollection services = new ServiceCollection();
            services.AddSingleton(new ModularGroupDataItemRepositoryOptions() { DbClient = _dbClient, ConnectionString = connString });
        ...
        /// <summary>
        /// Asserts that the instance of the <c>AddLocalizedGroupDataItemRepository</c> was created with the correct instance of <c>IModularDbClient</c> when the method is called
        /// without arguments, and falls back to the retrieving an instance of <c>IOptions&lt;LocalizedGroupDataItemRepositoryOptions&gt;</c> from the service collection.
        /// </summary>
        /// <param name="dbClient">The database client.</param>
        /// <param name="connString">The connection string.</param>
        /// <remarks>
        ...
        {
            IServiceCollection services = new ServiceCollection();
            services.AddSingleton<IOptions<ModularGroupDataItemRepositoryOptions>>(new OptionsWrapper<ModularGroupDataItemRepositoryOptions>(new ModularGroupDataItemRepositoryOptions() { DbClient = _dbClient, ConnectionString = connString }));
            services.AddModularGroupDataItemRepository();
        ...
        /// <summary>
        /// Asserts that the instance of the <c>AddLocalizedGroupDataItemRepository</c> was created with the correct instance of <c>IModularDbClient</c> when the method is called with lambda options
        /// </summary>
        /// <param name="dbClient">The database client.</param>
        /// <param name="connString">The connection string.</param>
        /// <remarks>
        ...
        /// <summary>Asserts that the service collection returns a singleton for <c>ILocalizedGroupDataItemRepository</c></summary>
        /// <autogeneratedoc />
        [TestMethod]
        public void ServiceCollection_Instance_Should_Be_Singleton()
        {
            ...
            var repo = svcProvider.GetRequiredService<IModularGroupDataItemRepository>();
            var scopeFactory = svcProvider.GetRequiredService<IServiceScopeFactory>();

            using var scope = scopeFactory.CreateScope();
            var scopeProvider = scope.ServiceProvider;
            var scopedRepo = scopeProvider.GetRequiredService<IModularGroupDataItemRepository>();
