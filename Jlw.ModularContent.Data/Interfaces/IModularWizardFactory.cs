...
namespace Jlw.ModularContent
{
    ...
    public interface IModularWizardFactory
    {
        /// <summary>
        ...
        IModularWizardContent CreateWizardContent(string groupKey, object formData = null);
        ...
        /// <returns></returns>
        IModularWizardContent CreateWizardScreenContent(string groupKey, string screenKey, object formData = null, string language=null, string groupFilter=null);
        ...
        /// <param name="formData"></param>
        /// <returns></returns>
        ModularWizardContentEmail CreateWizardContentEmail(string groupKey, string parentKey, object formData = null);
        ...
        void AddEmbeddedForm(string key, IModularWizardContent content, IEnumerable<ModularWizardContentField> extraFields = null, bool isDisabled = false, bool hasEditButton = false);

        /// ToDo: Add XMLDoc comments
        ModularWizardFormData CreateEmbeddedScreenFormData(IModularWizardContentField embed, IEnumerable<ModularWizardContentField> fieldData);
