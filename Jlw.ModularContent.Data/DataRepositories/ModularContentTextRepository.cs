...
namespace Jlw.ModularContent 
{
    ...
    public class ModularContentTextRepository : ModularDataRepositoryBase<IModularContentText, ModularContentText>, IModularContentTextRepository 
    {
        /// <summary>
        /// The sp get record
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModularContentTextRepository"/> class.
        /// </summary>
        /// <param name="dbClient">The database client.</param>
        /// <param name="connString">The connection string.</param>
        /// TODO Edit XML Comment Template for #ctor
        public ModularContentTextRepository(IModularDbClient dbClient, string connString) : base(dbClient, connString) 
        { 
        ...
        public object GetDataTableList(ModularContentTextDataTablesInput o)
        {
