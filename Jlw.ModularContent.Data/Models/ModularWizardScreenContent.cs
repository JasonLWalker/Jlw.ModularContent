...
namespace Jlw.ModularContent
{
    ...
    /// </summary>
    public class ModularWizardScreenContent : ModularWizardContent
    {
        /// <summary>
        ...
        public ModularWizardScreenContent(string screenId, IEnumerable<IModularWizardContentField> fieldData, object formData = null) : base(fieldData, formData)
        {
            ...
            ((List<ModularWizardButtonData>)Buttons).Clear();
            ((List<ModularWizardFormData>)Forms).Clear();
