...
{
    /// <inheritdoc />
    public class ModularWizardContentEmail : IModularWizardContentEmail
    {
        /// <inheritdoc />
        ...
        public ModularWizardContentEmail(string parentKey, IEnumerable<IModularWizardContentField> fieldData, object formData = null)
        {
