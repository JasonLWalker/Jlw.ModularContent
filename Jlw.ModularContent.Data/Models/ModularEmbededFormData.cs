...
{
    public class ModularEmbededFormData : ModularWizardFormData
    {
        public ModularEmbededFormData(IModularWizardContentField baseField, string formKey, string screenName, IEnumerable<ModularWizardContentField> fieldData, ModularWizardButtonData editButton = null) : base(formKey, screenName, fieldData, editButton)
        {
